...
if (FireBaseHelper.internet_on):
    ...
    FirebaseData= FireBaseHelper.GetJSONFromFile(FireBaseHelper.FirebaseFilepath,FireBaseHelper.MeetNumber)

    LocalData=  FireBaseHelper.GetJSONFromFile(FireBaseHelper.LocalFilepath,FireBaseHelper.MeetNumber)

    while True:
        sleep(0.1)
        LocalData=  FireBaseHelper.GetJSONFromFile(FireBaseHelper.LocalFilepath,FireBaseHelper.MeetNumber)
        #LocalData=  FireBaseHelper.GetJSONFromFile(FireBaseHelper.LocalFilepath,FireBaseHelper.MeetNumber)
        FireBaseHelper.generateTimeUpdateListsforFirebase(LocalData,FirebaseData)    
        #print("For Firebase")
