...
PANEL_W = 800                       # data panel width
PANEL_H = 1000                       # data panel height
# -----------------------------------------------------
...
class OverlayWindow(QtWidgets.QFrame):
    ...
    def __init__(self, parent_window: QtWidgets.QMainWindow, target_widget: QtWidgets.QWidget):
        ...
        self.setAttribute(QtCore.Qt.WA_TransparentForMouseEvents, True)   # remove if you want scroll/click
        ...
        # App-level signals to react to focus / app activation changes
    ...
    def _sync_geometry(self):
        ...
        margin = 24  # increased to avoid right-edge clipping
