...
# ------------------ CONFIGURE THESE ------------------
RTSP_URL = "rtsp://user:pass@192.168.0.100:554/Streaming/Channels/101"  # <- your camera URL
REST_URL = "http://192.168.0.101:8002/SetLiveHeatCommands?CmdName=LiveBoard"  # <- your REST endpoint
